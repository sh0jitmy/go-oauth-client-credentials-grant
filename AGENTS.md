...
6. **Multi-Tier E2E Testing Framework**: Fast No-Docker SQLite E2E (`make sqlite-e2e`), OAuth2 & ACME HTTP-01 E2E (`make oauth-e2e`), Headless Chrome frontend UI assertions (`make frontend-e2e`), and Docker Compose full-stack E2E (`make docker-e2e`).
...
make oauth-e2e       # OAuth 2.0 & ACME HTTP-01 Challenge E2E
